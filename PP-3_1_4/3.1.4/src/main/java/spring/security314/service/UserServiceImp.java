...
//        roleUser.add(roleUs);
//
//        User user1 = new User( "Admin1", "Good", 54, "admin@gmail.com", "admin", roleAdmin);
//        User user2 = new User( "User1", "Norm", 24, "user@gmail.com", "user", roleUser);
//
//        add(user1);
//        add(user2);
//    }
